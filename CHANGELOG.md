...
- fix(task): fix a bug than happens when less than min(self.batch_size, 9) examples are used in the validation ([@antoinelaurent](https://github.com/antoinelaurent/))
