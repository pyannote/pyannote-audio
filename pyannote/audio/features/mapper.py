# GenderChiMapper for mapping to [CHI,FEM,MAL,SPEECH]
# GenderOthChiMapper for mapping to [CHI,KCHI,FEM,MAL,SPEECH]


class GenderOthChiMapper(object):
    """Maps all the classes to [CHI,KCHI,FEM,MAL,SPEECH]"""
...
class GenderChiMapper(object):
    """Maps all the classes to [CHI,FEM,MAL,SPEECH]"""
    def __init__(self, speech=False):
        self.speech = speech
    ...
    def __call__(self, item):
        ...
        # If model must predict "SPEECH", then all the speakers who are not
        # classified as being [CHI,CHI,FEM,MAL] are classified as being "SPEECH".
        # If not, these classes are classified as being "SIL".
        if not self.speech:
            for key, value in dict_map.items():
                if value == "SPEECH":
